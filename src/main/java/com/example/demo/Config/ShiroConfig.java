...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filtersMap.put("urlFilter", new URLPathMatchingFilter());
        ...
        filterChainDefinitionMap.put("/admin/**", "authc,urlFilter");
        filterChainDefinitionMap.put("/user/**", "authc,urlFilter");
